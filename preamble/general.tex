...
\PassOptionsToPackage{%
 ...
 \usepackage{geometry}
 \geometry{
 paperwidth=14.8cm,paperheight=21.0cm,
 bindingoffset=0.25cm, % gutter
 inner=2cm, % inside margin
...
\renewcommand{\cftpartpagefont}{\normalfont}%
  ...
  \titleformat{\part}[display]
         ...
         {\color{chapter-color}\spacedallcaps}[\bigskip\normalfont\normalsize\color{Black}]
...
%\usepackage[width=14.9truecm,height=21.0truecm,cam, axes, frame, cross, center]{crop}
