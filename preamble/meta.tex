...
%
\newcommand{\myTitle}{%
  Systems and Software for Secure Trusted Path in Modern Computing Platform\xspace%
}
\newcommand{\myPlainTitle}{%
Systems and Software for SecureTrusted Path in Modern Computing Platform\xspace%
}
