...
% A small recipe for when you have space issues :-)
% Baseline
...
\newcommand{\dl}[1]{\textcolor{orange}{Daniele: #1}}
\newcommand{\enis}[1]{\textcolor{violet}{#1}}
\newcommand{\red}[1]{\textcolor{red}{#1}}

\newcommand{\TODO}[1]{\footnote{\color{red} \textbf{#1}}}
\newcommand{\capTODO}[1]{\color{red} #1}
% \newcommand{\TODO}[1]{}
% \newcommand{\capTODO}[1]{}
\newcommand{\MAYBE}[1]{}
\newcommand{\TODMECH}[1]{}
...
\newcommand{\webusb}{\texttt{WebUSB}\xspace}
\newcommand{\webbt}{\texttt{WebBlueTooth}\xspace}
...
% \title{\sysname: Continuous Authentication of User Input by Visual Client Supervision}


\graphicspath{{images/}}

% REMEMBER TO REMOVE PAGE NUMBERS!
%\pagestyle{plain}
%\settopmatter{printfolios=true}
...
\acmConference[AsiaCCS '21]{AsiaCCS: 16th ACM ASIA Conference on Computer and Communications Security}{June 07--11, 2021}{Hong Kong, China}
\acmBooktitle{AsiaCCS: 16th ACM ASIA Conference on Computer and Communications Security, June 07--11, 2021, Hong Kong, China}
\acmPrice{15.00}
\acmISBN{978-1-4503-XXXX-X/20/07}

\begin{document}

%\title[\sysname]{\sysname: Visually Supervising Remote User Interactions through Compromised Clients}
\title[\sysname: Visually Supervising Remote User Interactions on Compromised Clients]{%\sysname: Visually Supervising Compromised Clients during Remote User Interactions \\ . \\
...
% Finally, the results of the usability study show that users found the developed prototype to be usable, suggesting the potential for practical application of visual supervision of users' interactions with other electronic devices.

\end{abstract}

\maketitle

% \title{\sysname: Protecting User Input Integrity Using Visual Proofs-of-Intent}
...
% \section{Text recognition mismatches}

% It is important to note that the verification rates depend both on real-time detection and realignment of the captured video, and on the general performance of the used OCR engine.
% We provide a sampling of OCR mismatches in Table~\ref{table:OCRMismatches}.
% Despite some of the randomly generated forms being mismatched, the analysis shows that the majority of failures are a result of a consistent mismatch of a single UI element, which was often misdetected by a single character.
...
% \centering
% \small
%   \caption{A sample of text recognition mismatches.}
%   \begin{tabular}{@{}lr@{}}

% 		\textbf{Actual Text}  & \textbf{Detected Text} \\
%   	\toprule
% 	  	FBN 		&	FB \\
% 	  	mummify		& 	munmmi \\
% 		RXSTFHJJ 	& 	RXSTFHIJ \\
% 	  	nebulae 	& 	bulae \\
% 	  	4714004 	& 	471400 \\
% 		280 		&	\textit{[not detected]} \\
% 		064 		& 	054 \\
% 		bairn 		& 	baim \\
%     \bottomrule
%   \end{tabular}
%   \label{table:OCRMismatches}
% \end{table}
