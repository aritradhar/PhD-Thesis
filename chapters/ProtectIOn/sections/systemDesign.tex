...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item \texttt{trigger} is important only for the element that either trigger the input to the form to submit (\texttt{trigger=true}) to the server ot reset (\texttt{trigger=false}) the form to its initial state.
  \end{itemize}
\end{enumerate}
