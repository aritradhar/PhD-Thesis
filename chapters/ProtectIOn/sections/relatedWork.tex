...
\resizebox{\textwidth}{!}{
  \begin{tabular}{l !{\vline width 1pt} l !{\vline width 1pt} c  c  c  c !{\vline width 1pt} c  c  c  c !{\vline width 1pt} c c} 
   ...
   \Xhline{1pt}    
    &GPU separation~\cite{10.1145/2810103.2813719}             &          &       & \yes         & \yes     &               &       &           & \yesNope &   & \\
    \rowcolor{Gray}
    ...
    \rowcolor{Gray}
    \cellcolor{white}\parbox[t]{1mm}{\multirow{-12}{*}{\rotatebox[origin=c]{90}{\textbf{Hypervisor/OS-based}}}}  \ldelim\{{-12}{0mm}[] & SchrodinText~\cite{sani2017schrodintext}     & \yes     &   &      & \yes     &               &       &           & \yes &  &  \\
    ...
    \rowcolor{Gray}
    \cellcolor{white}&\textsc{ProximiTee} (Chapter~\ref{ch:proximitee})&\yes         & \yes  & \yesNope     &      & \yes             &       &           &   &\yes &\yes\\
    ...
    \rowcolor{Gray}
    &Terra~\cite{garfinkel2003terra}                 &          & \yes  & \yesNope     &      &              &       &           &   &  & \\ 
    \cellcolor{white} \cellcolor{white}\parbox[t]{5mm}{\multirow{-7}{*}{\rotatebox[origin=c]{90}{\textbf{External HW}}}}  \ldelim\{{-7}{0mm}[] &Lockdown~\cite{vasudevan2012lockdown}                 &          & \yes  & \yes     &      &       \yes       &  \yes     &    \yes       & \yesNope  &  & \yes\\ 
    \\[-1em]
    \rowcolor{white}
    \Xhline{1pt}
