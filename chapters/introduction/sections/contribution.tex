...
Given the problem space discussed above, this thesis addresses the a number of research questions (RQ) concerning the trusted path and trusted execution in modern platforms. The first being:
