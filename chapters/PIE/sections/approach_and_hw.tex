...
\begin{figure}[t]
  \centering
  \includegraphics[trim={0 5cm 15cm 0}, clip, width=\linewidth]{chapters/PIE/images/localAttestation.pdf}
  \caption{\textbf{Flow of the remote attestation process} between the user, $E_1$, $E_2$ and the \sphw firmware.} %\vspace{-1.5em}
