...
\begin{tikzpicture}[
    ...
    \draw[<->,very thick] ([xshift=-1em]cpu.south) -- ([xshift=-1em]memory.north);
    % \pause
    \node[icon] (keyboard) at (0,4) {\imgkeyboard};
    \node[icon] (mouse) at (0,2) {\imgmouse};
    ...
    % \pause
    \node[icon] (nic) at (8,4) {\imglan};
    \node[icon] (gpu) at (8,2) {\imggpu};
    ...
    % \node[draw=none] at (6, 1.2) {PCI};
    % \node[draw=none] at (2, 1.2) {SPI};
    \node[draw=none,above=0cm of cpu] {Processor};
    \node[draw=none,above=0cm of keyboard] {Keyboard};
    \node[draw=none,above=0cm of nic] {NIC};
    \node[draw=none,below=0cm of memory] {DRAM};
    \node[draw=none,below=0cm of mouse] {Mouse};
    \node[draw=none,below=0cm of gpu] {GPU};
