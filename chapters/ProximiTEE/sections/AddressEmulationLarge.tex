...
%\includegraphics[trim={0 13.5cm 21cm 0},clip,width=0.6\linewidth]{emulationAttack.pdf}
% \caption{\textbf{Emulation attack.} The attacker emulates a SGX processor on the target platform using a leaked attestation key.}
%\figsaver
% \label{fig:emulationAttack}
%\end{figure}
