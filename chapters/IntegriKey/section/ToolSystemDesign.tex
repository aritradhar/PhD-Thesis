...
\begin{figure}[t]
 ...
 \includegraphics[trim={0 2.3cm 12cm 0},clip,width=0.45\linewidth]{ServerSideTool_revised_2.pdf}
...
\begin{figure}[t]
 ...
 \caption{\textbf{UI conversion.} Conversion of radio button, drop-down menu and slider to an equivalent text field with added instructions.}
 \vspace{-10pt}
 \label{fig:uiConv}
\end{figure}
