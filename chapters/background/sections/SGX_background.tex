...
\begin{figure}[t]
  \centering
    ...
    \caption[Intel SGX remote attestation]{\textbf{Intel SGX remote attestation.} Intel SGX remote attestation example that involves the application enclave, quoring enclave, challenger and Intel attestation server. This figure is a reproduction of the figure in Intel's white paper~\cite{attestation_primitive_all}.}
    \label{fig:ra_bg}
\end{figure}
